...
public class SchedulingConfig {
    ...
    /**
     * SchedulerClient bean is always on and is used to schedule jobs, but does NOT execute them.
     ...
     * Use environment variable "DB_SCHEDULER_EXECUTOR_ENABLED" = true to enable execution.
